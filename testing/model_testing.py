...
import pandas as pd
import numpy as np
from utils import data_pipeline as pipeline
from utils import model_tools as tools
from models import rfts as myRFTS
from models import xgb as myXGB
from models import hmm as myHMM 
from models import exp_smoothing as myEXPS
...
#%% Run a RFTS model
RFTSmodel, holdout_pred_rfts, outlier_rfts = myRFTS.RFTS(df_mod, target_col=f'{target_item}', holdout=500, outlier_threshold=30, max_depth=5, n_estimators=400, min_samples_leaf=20)
tools.plot_pred_vs_price(df_mod, model=RFTSmodel,lookback=1000,holdout_pred=holdout_pred_rfts,fill_outliers=outlier_rfts)
