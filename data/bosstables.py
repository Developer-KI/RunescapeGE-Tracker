...
bryophyta = [item_name("Bryophyta's essence")]
callisto = [item_name("Tyrannical ring")]
cerberus = [
...
item_name("Jar of dreams"),
]
obor = [
item_name("Hill giant club"),
]
phantom_muspah = [
...
sarachnis = [
item_name("Jar of eyes"),
item_name("Sarachnis cudgel"),
item_name("Giant egg sac(full)"),
]
scorpia = [
